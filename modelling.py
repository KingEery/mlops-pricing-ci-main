...
def main():
    ...
    # Membaca URI dari environment variable agar aman di GitHub Actions
    remote_server_uri = os.getenv("MLFLOW_TRACKING_URI")
    if remote_server_uri:
        mlflow.set_tracking_uri(remote_server_uri)
        print(f"Tracking to remote: {remote_server_uri}")
    else:
        # Jika run lokal tanpa env var, akan simpan di folder mlruns
    ...
    # 4. MLflow Run
    # Menggunakan 'with' agar run tertutup otomatis dan tercatat dengan benar
    with mlflow.start_run():
        ...
        print("Run Complete and Logged Successfully.")
